<template>
  <div class="girl-c" ref="girl">
    <img v-if="picNum===1" class="girl-pic" src="./img/ct_1.png" />
    <img v-if="picNum===2" class="girl-pic" src="./img/ct_5.png" />
    <img v-if="picNum===3" class="girl-pic" src="./img/ct_4.png" />
    <img v-if="picNum===4" class="girl-pic" src="./img/ct_3.png" />
    <img v-if="picNum===5" class="girl-pic" src="./img/ct_2.png" />
    <div
      class="girl-main"
